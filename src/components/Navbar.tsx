        ...
        <div className="lg:hidden absolute left-0 right-0 top-0 h-14 flex items-center justify-between px-4 bg-[#e8e8e8] z-50">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-1.5 bg-[#25D366] hover:bg-[#128C7E] text-white px-3 py-1.5 rounded-full transition-colors font-medium text-sm shadow-sm"
              aria-label="WhatsApp"
            >
            ...
            >
              {open ? <X className="w-8 h-8 text-primary" /> : <Menu className="w-8 h-8 text-primary" />}
            </button>
          </div>
        </div>
      </div>
